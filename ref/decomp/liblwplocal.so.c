...
void __fastcall renderer::init(renderer *this, AAssetManager *a2);
float __fastcall mix(float a1, float a2, float a3);
std::string *__fastcall renderer::getfile(std::string *a1, int a2, AAssetManager *a3, const char **a4);
...
_DWORD *__fastcall renderer::buildShaderFile(_DWORD *a1, int a2, AAssetManager *a3, const std::string *a4, const std::string *a5);
...
void __fastcall renderer::render(render *this, AAssetManager *a2);
...
AAssetManager *__fastcall theme(AAssetManager *a1, AAssetManager *a2, int a3);
void __fastcall Curve::requestColors(Curve *this, AAssetManager *a2, int a3);
void __fastcall Curve::Curve(Curve *this, AAssetManager *a2);
...
int __fastcall Java_com_sonymobile_experienceflow_renderer_CurveRenderer_init(JNIEnv *a1, int a2, void *a3, _DWORD *a4)
{
  ...
  v7 = AAssetManager_fromJava(a1, a3);
  if ( !*((_BYTE *)v6 + 4) )
  {
    *((_BYTE *)v6 + 4) = 1;
        ...
        _DWORD *a4)
{
  ...
  v7 = AAssetManager_fromJava(a1, a4);
        ...
        int a5)
{
  ...
  v8 = AAssetManager_fromJava(a1, a4);
...
AAssetManager *__fastcall theme(AAssetManager *a1, AAssetManager *a2, int a3)
{
  ...
  v8 = AAssetManager_open(a2, filename[0], 3);
...
//----- (00012200) --------------------------------------------------------
// Alternative name is '_ZN5CurveC2EP13AAssetManager'
void __fastcall Curve::Curve(Curve *this, AAssetManager *a2)
{
  CurveClient *v4; // r7
  AAsset *v5; // r4
  ...
  *((_DWORD *)this + 92) = 0;
  ...
  v5 = AAssetManager_open(a2, "noise.png", 3);
